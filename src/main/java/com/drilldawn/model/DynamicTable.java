...
public class DynamicTable {
    ...
    public DynamicTable(SimpleStringProperty idRoot, SimpleStringProperty securityType, SimpleStringProperty symbol,
    ...
    public DynamicTable(String idRoot, String securityType, String symbol,
